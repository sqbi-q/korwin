...
namespace korwin
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int o1 = r.Next(s1.Length);
            int o2 = r.Next(s2.Length);
            int o3 = r.Next(s3.Length);
            int o4 = r.Next(s4.Length);
            int o5 = r.Next(s5.Length);
            int o6 = r.Next(s6.Length);

            Console.WriteLine($"{s1[o1] + " " + s2[o2] + " " + s3[o3] + " " + s4[o4] + " " + s5[o5] + " " + s6[o6]}");
            Console.ReadKey();
        }
    }
}
