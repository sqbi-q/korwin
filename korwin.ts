...
let txt: string = korwin1[Math.floor(Math.random() * (korwin1.length - 1))] + " ";
txt += korwin2[Math.floor(Math.random() * (korwin2.length - 1))] + " ";
txt += korwin3[Math.floor(Math.random() * (korwin3.length - 1))] + " ";
txt += korwin4[Math.floor(Math.random() * (korwin4.length - 1))] + " ";
txt += korwin5[Math.floor(Math.random() * (korwin5.length - 1))] + " ";
txt += korwin6[Math.floor(Math.random() * (korwin6.length - 1))];
