...
$txt = $korwin1[rand(0, count($korwin1) - 1)] . " ";
$txt .= $korwin2[rand(0, count($korwin2) - 1)] . " ";
$txt .= $korwin3[rand(0, count($korwin3) - 1)] . " ";
$txt .= $korwin4[rand(0, count($korwin4) - 1)] . " ";
$txt .= $korwin5[rand(0, count($korwin5) - 1)] . " ";
$txt .= $korwin6[rand(0, count($korwin6) - 1)];
echo $txt;
